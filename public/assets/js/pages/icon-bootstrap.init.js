...
!function($) {
    ...
    var BootstrapIcon = function() {
        ...
        function getIconItem(icon, isNewIcon) {
            ...
            span.appendChild(document.createTextNode('bi-' + icon.name));
        ...
        const filledIcon = document.getElementById('filled-icon');

        const lineIcon = document.getElementById('line-icon');


        filledIcons.forEach(function(icon){
            filledIcon.appendChild(getIconItem(icon));
        });

        lineIcons.forEach(function(icon){
            lineIcon.appendChild(getIconItem(icon));
        });
    ...
    /* Initializing */
    BootstrapIcon.prototype.init = function() {
    },

   //init CalendarApp
    $.BootstrapIcon = new BootstrapIcon, $.BootstrapIcon.Constructor = BootstrapIcon
